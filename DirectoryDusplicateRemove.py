# Description :- File Automation delete duplicate files in the input directory
...
# Description :- To delete duplicate file
# Input :- values of dict which is generated by the FindDups function
# Output :- delete duplicate file
# Author :- Yendhe Anuraj Balasaheb
# Date :- 07/09/2024
######################################################################
...
def main():
    ...
    if(len(argv) == 2):
        if(argv[1] == "-h") or (argv[1] == "-H"):
            print("This Script is used to delete duplicate files in input the directory")
            exit()

        elif(argv[1] == "-u") or (argv[1] == "-U"):
            print('usage : Name_of_script.py "Path_of_directory"')
            print('Example: DirectoryDusplicateRemove.py "Anuraj"')
            exit()

        else:
            try:
                startTime = time.time()
                arr = DeleteDups(argv[1])
                endTime = time.time()
